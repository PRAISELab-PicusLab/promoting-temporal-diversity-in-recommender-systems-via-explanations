...
def recommender(model, dataset, iteration, corrective_iteration, trained_model):
    if model in ['PGPR', 'CAFE']:
        # -------------------------------
...
def main():
    ...
    recommender(args.model, args.dataset, args.iteration, args.corrective_iteration, args.initial_model)
