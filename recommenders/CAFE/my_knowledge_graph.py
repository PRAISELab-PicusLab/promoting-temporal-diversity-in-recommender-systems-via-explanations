...
RELATION_LIST = {
    ML1M: [WATCHED],
    #ML1M: [BELONG_TO, PRODUCED_BY_PRODUCER, WATCHED, DIRECTED_BY, PRODUCED_BY_COMPANY, STARRING, EDITED_BY, WROTE_BY, CINEMATOGRAPHY_BY, COMPOSED_BY, PRODUCED_IN, RELATED_TO],
    LASTFM: [LISTENED],
